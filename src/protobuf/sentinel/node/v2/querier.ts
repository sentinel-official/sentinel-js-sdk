...
export const QueryNodeRequest: MessageFns<QueryNodeRequest> = {
  encode(message: QueryNodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
...
export const QueryNodeResponse: MessageFns<QueryNodeResponse> = {
  encode(message: QueryNodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export class QueryServiceClientImpl implements QueryService {
  ...
  QueryNodes(request: QueryNodesRequest): Promise<QueryNodesResponse> {
    ...
    return promise.then((data) => QueryNodesResponse.decode(new BinaryReader(data)));
  }
  ...
  QueryNode(request: QueryNodeRequest): Promise<QueryNodeResponse> {
    ...
    return promise.then((data) => QueryNodeResponse.decode(new BinaryReader(data)));
  }
