...
export const QueryNodesForProviderRequest: MessageFns<QueryNodesForProviderRequest> = {
  encode(message: QueryNodesForProviderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryNodesForProviderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryNodesForProviderResponse: MessageFns<QueryNodesForProviderResponse> = {
  encode(message: QueryNodesForProviderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.nodes) {
      Node.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryNodesForProviderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export class QueryServiceClientImpl implements QueryService {
  ...
  QueryNodesForProvider(request: QueryNodesForProviderRequest): Promise<QueryNodesForProviderResponse> {
    ...
    return promise.then((data) => QueryNodesForProviderResponse.decode(new BinaryReader(data)));
  }
