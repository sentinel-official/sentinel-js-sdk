...
export const QueryLeasesRequest: MessageFns<QueryLeasesRequest> = {
...
export const QueryLeasesForNodeRequest: MessageFns<QueryLeasesForNodeRequest> = {
  encode(message: QueryLeasesForNodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryLeasesForNodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryLeasesForProviderRequest: MessageFns<QueryLeasesForProviderRequest> = {
  encode(message: QueryLeasesForProviderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryLeasesForProviderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryLeaseRequest: MessageFns<QueryLeaseRequest> = {
...
export const QueryLeasesResponse: MessageFns<QueryLeasesResponse> = {
  encode(message: QueryLeasesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.leases) {
      Lease.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
...
export const QueryLeasesForNodeResponse: MessageFns<QueryLeasesForNodeResponse> = {
  encode(message: QueryLeasesForNodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.leases) {
      Lease.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryLeasesForNodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryLeasesForProviderResponse: MessageFns<QueryLeasesForProviderResponse> = {
  encode(message: QueryLeasesForProviderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.leases) {
      Lease.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryLeasesForProviderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export class QueryServiceClientImpl implements QueryService {
  ...
  QueryLeasesForNode(request: QueryLeasesForNodeRequest): Promise<QueryLeasesForNodeResponse> {
    ...
    return promise.then((data) => QueryLeasesForNodeResponse.decode(new BinaryReader(data)));
  }
  ...
  QueryLeasesForProvider(request: QueryLeasesForProviderRequest): Promise<QueryLeasesForProviderResponse> {
    ...
    return promise.then((data) => QueryLeasesForProviderResponse.decode(new BinaryReader(data)));
  }
