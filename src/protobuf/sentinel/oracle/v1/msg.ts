...
export const MsgCreateAssetRequest = {
  encode(message: MsgCreateAssetRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.protoRevPoolRequest !== undefined) {
      QueryGetProtoRevPoolRequest.encode(message.protoRevPoolRequest, writer.uint32(34).fork()).ldelim();
    }
    if (message.spotPriceRequest !== undefined) {
      SpotPriceRequest.encode(message.spotPriceRequest, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
