...
export const QuerySwapsRequest: MessageFns<QuerySwapsRequest> = {
  encode(message: QuerySwapsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySwapsRequest {
...
export const QuerySwapRequest: MessageFns<QuerySwapRequest> = {
  encode(message: QuerySwapRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const QuerySwapsResponse: MessageFns<QuerySwapsResponse> = {
  encode(message: QuerySwapsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.swaps) {
      Swap.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySwapsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySwapResponse: MessageFns<QuerySwapResponse> = {
  encode(message: QuerySwapResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.swap !== undefined) {
      Swap.encode(message.swap, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export class QueryServiceClientImpl implements QueryService {
  ...
  QuerySwaps(request: QuerySwapsRequest): Promise<QuerySwapsResponse> {
    ...
    return promise.then((data) => QuerySwapsResponse.decode(new BinaryReader(data)));
  }
