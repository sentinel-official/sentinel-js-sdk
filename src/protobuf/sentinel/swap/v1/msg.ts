...
export const MsgSwapRequest: MessageFns<MsgSwapRequest> = {
  encode(message: MsgSwapRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSwapRequest {
