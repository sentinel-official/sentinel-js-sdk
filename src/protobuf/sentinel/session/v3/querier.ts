...
export const QuerySessionsForAccountRequest: MessageFns<QuerySessionsForAccountRequest> = {
  encode(message: QuerySessionsForAccountRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySessionsForAccountRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySessionsForAllocationRequest: MessageFns<QuerySessionsForAllocationRequest> = {
  encode(message: QuerySessionsForAllocationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySessionsForAllocationRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySessionsForNodeRequest: MessageFns<QuerySessionsForNodeRequest> = {
  encode(message: QuerySessionsForNodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySessionsForNodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySessionsForSubscriptionRequest: MessageFns<QuerySessionsForSubscriptionRequest> = {
  encode(message: QuerySessionsForSubscriptionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.id.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.id.toString());
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySessionsForSubscriptionRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySessionsForAccountResponse: MessageFns<QuerySessionsForAccountResponse> = {
  encode(message: QuerySessionsForAccountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.sessions) {
      Any.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySessionsForAccountResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySessionsForAllocationResponse: MessageFns<QuerySessionsForAllocationResponse> = {
  encode(message: QuerySessionsForAllocationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.sessions) {
      Any.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySessionsForAllocationResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySessionsForNodeResponse: MessageFns<QuerySessionsForNodeResponse> = {
  encode(message: QuerySessionsForNodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.sessions) {
      Any.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySessionsForNodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySessionsForSubscriptionResponse: MessageFns<QuerySessionsForSubscriptionResponse> = {
  encode(message: QuerySessionsForSubscriptionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.sessions) {
      Any.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySessionsForSubscriptionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySessionResponse: MessageFns<QuerySessionResponse> = {
  encode(message: QuerySessionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.session !== undefined) {
      Any.encode(message.session, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export class QueryServiceClientImpl implements QueryService {
  ...
  QuerySessionsForAccount(request: QuerySessionsForAccountRequest): Promise<QuerySessionsForAccountResponse> {
    ...
    return promise.then((data) => QuerySessionsForAccountResponse.decode(new BinaryReader(data)));
  }
  ...
  QuerySessionsForNode(request: QuerySessionsForNodeRequest): Promise<QuerySessionsForNodeResponse> {
    ...
    return promise.then((data) => QuerySessionsForNodeResponse.decode(new BinaryReader(data)));
  }
  ...
  QuerySessionsForSubscription(
    ...
    return promise.then((data) => QuerySessionsForSubscriptionResponse.decode(new BinaryReader(data)));
  }
  ...
  QuerySessionsForAllocation(request: QuerySessionsForAllocationRequest): Promise<QuerySessionsForAllocationResponse> {
    ...
    return promise.then((data) => QuerySessionsForAllocationResponse.decode(new BinaryReader(data)));
  }
