...
export const EventPay: MessageFns<EventPay> = {
  encode(message: EventPay, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.subscription.equals(Long.UZERO)) {
      writer.uint32(24).uint64(message.subscription.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.subscription = Long.fromString(reader.uint64().toString(), true);
          continue;
        }
        case 4: {
          if (tag !== 34) {
