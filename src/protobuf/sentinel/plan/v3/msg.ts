...
function createBaseMsgCreatePlanRequest(): MsgCreatePlanRequest {
  return { from: "", bytes: "", duration: undefined, prices: [], private: false };
}

export const MsgCreatePlanRequest: MessageFns<MsgCreatePlanRequest> = {
...
function createBaseMsgUpdatePlanDetailsRequest(): MsgUpdatePlanDetailsRequest {
  return { from: "", id: Long.UZERO, private: false };
}

export const MsgUpdatePlanDetailsRequest: MessageFns<MsgUpdatePlanDetailsRequest> = {
  ...
  create(base?: DeepPartial<MsgUpdatePlanDetailsRequest>): MsgUpdatePlanDetailsRequest {
    return MsgUpdatePlanDetailsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MsgUpdatePlanDetailsRequest>): MsgUpdatePlanDetailsRequest {
    const message = createBaseMsgUpdatePlanDetailsRequest();
    message.from = object.from ?? "";
    message.id = (object.id !== undefined && object.id !== null) ? Long.fromValue(object.id) : Long.UZERO;
    message.private = object.private ?? false;
...
export const MsgUpdatePlanStatusRequest: MessageFns<MsgUpdatePlanStatusRequest> = {
...
export const MsgCreatePlanResponse: MessageFns<MsgCreatePlanResponse> = {
...
export const MsgUpdatePlanDetailsResponse: MessageFns<MsgUpdatePlanDetailsResponse> = {
  ...
  create(base?: DeepPartial<MsgUpdatePlanDetailsResponse>): MsgUpdatePlanDetailsResponse {
    return MsgUpdatePlanDetailsResponse.fromPartial(base ?? {});
  },
  fromPartial(_: DeepPartial<MsgUpdatePlanDetailsResponse>): MsgUpdatePlanDetailsResponse {
    const message = createBaseMsgUpdatePlanDetailsResponse();
    return message;
  },
};
...
export const MsgUpdatePlanStatusResponse: MessageFns<MsgUpdatePlanStatusResponse> = {
