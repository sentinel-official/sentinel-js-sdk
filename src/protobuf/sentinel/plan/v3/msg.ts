...
export const MsgUpdatePlanDetailsRequest = {
  encode(message: MsgUpdatePlanDetailsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
    if (!message.id.equals(Long.UZERO)) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdatePlanDetailsRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdatePlanDetailsResponse = {
  encode(_: MsgUpdatePlanDetailsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdatePlanDetailsResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgServiceClientImpl implements MsgService {
  ...
  MsgUpdatePlanDetails(request: MsgUpdatePlanDetailsRequest): Promise<MsgUpdatePlanDetailsResponse> {
    ...
    return promise.then((data) => MsgUpdatePlanDetailsResponse.decode(_m0.Reader.create(data)));
  }
