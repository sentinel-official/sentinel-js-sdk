...
export const GenesisPlan: MessageFns<GenesisPlan> = {
  encode(message: GenesisPlan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GenesisPlan {
...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.plans) {
      GenesisPlan.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },
