...
export const MsgAddRequest: MessageFns<MsgAddRequest> = {
  encode(message: MsgAddRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
    ...
    if (message.validity !== undefined) {
      Duration.encode(message.validity, writer.uint32(26).fork()).join();
    }
    if (message.bytes !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgAddRequest {
...
export const MsgAddNodeRequest: MessageFns<MsgAddNodeRequest> = {
  encode(message: MsgAddNodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgAddNodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgRemoveNodeRequest: MessageFns<MsgRemoveNodeRequest> = {
  encode(message: MsgRemoveNodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
    if (!message.id.equals(Long.UZERO)) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgRemoveNodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSetStatusRequest: MessageFns<MsgSetStatusRequest> = {
  encode(message: MsgSetStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
    if (!message.id.equals(Long.UZERO)) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSetStatusRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgAddResponse: MessageFns<MsgAddResponse> = {
  encode(_: MsgAddResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgAddResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgAddNodeResponse: MessageFns<MsgAddNodeResponse> = {
  encode(_: MsgAddNodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgAddNodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgRemoveNodeResponse: MessageFns<MsgRemoveNodeResponse> = {
  encode(_: MsgRemoveNodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgRemoveNodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSetStatusResponse: MessageFns<MsgSetStatusResponse> = {
  encode(_: MsgSetStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgSetStatusResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
