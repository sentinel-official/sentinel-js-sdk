...
export const EventAddNode: MessageFns<EventAddNode> = {
  encode(message: EventAddNode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.id.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.id.toString());
    }
    if (message.node !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventAddNode {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const EventRemoveNode: MessageFns<EventRemoveNode> = {
  encode(message: EventRemoveNode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.id.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.id.toString());
    }
    if (message.node !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventRemoveNode {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const EventSetStatus: MessageFns<EventSetStatus> = {
  encode(message: EventSetStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.id.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.id.toString());
    }
    if (message.provider !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EventSetStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
