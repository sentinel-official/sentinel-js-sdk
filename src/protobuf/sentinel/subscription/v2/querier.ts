...
export const QueryAllocationsRequest: MessageFns<QueryAllocationsRequest> = {
  encode(message: QueryAllocationsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryAllocationsRequest {
...
export const QueryAllocationRequest: MessageFns<QueryAllocationRequest> = {
...
export const QueryPayoutsRequest: MessageFns<QueryPayoutsRequest> = {
  encode(message: QueryPayoutsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPayoutsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPayoutsForAccountRequest: MessageFns<QueryPayoutsForAccountRequest> = {
  encode(message: QueryPayoutsForAccountRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPayoutsForAccountRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPayoutsForNodeRequest: MessageFns<QueryPayoutsForNodeRequest> = {
  encode(message: QueryPayoutsForNodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPayoutsForNodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPayoutRequest: MessageFns<QueryPayoutRequest> = {
...
export const QuerySubscriptionsForNodeRequest: MessageFns<QuerySubscriptionsForNodeRequest> = {
  encode(message: QuerySubscriptionsForNodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySubscriptionsForNodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryAllocationsResponse: MessageFns<QueryAllocationsResponse> = {
...
export const QueryAllocationResponse: MessageFns<QueryAllocationResponse> = {
...
export const QueryPayoutsResponse: MessageFns<QueryPayoutsResponse> = {
  encode(message: QueryPayoutsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.payouts) {
      Payout.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPayoutsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPayoutsForAccountResponse: MessageFns<QueryPayoutsForAccountResponse> = {
  encode(message: QueryPayoutsForAccountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.payouts) {
      Payout.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPayoutsForAccountResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPayoutsForNodeResponse: MessageFns<QueryPayoutsForNodeResponse> = {
  encode(message: QueryPayoutsForNodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.payouts) {
      Payout.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryPayoutsForNodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryPayoutResponse: MessageFns<QueryPayoutResponse> = {
  encode(message: QueryPayoutResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.payout !== undefined) {
      Payout.encode(message.payout, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const QuerySubscriptionsForNodeResponse: MessageFns<QuerySubscriptionsForNodeResponse> = {
  encode(message: QuerySubscriptionsForNodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.subscriptions) {
      Any.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySubscriptionsForNodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySubscriptionResponse: MessageFns<QuerySubscriptionResponse> = {
  encode(message: QuerySubscriptionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.subscription !== undefined) {
      Any.encode(message.subscription, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export class QueryServiceClientImpl implements QueryService {
  ...
  QueryAllocation(request: QueryAllocationRequest): Promise<QueryAllocationResponse> {
    ...
    return promise.then((data) => QueryAllocationResponse.decode(new BinaryReader(data)));
  }
  ...
  QueryAllocations(request: QueryAllocationsRequest): Promise<QueryAllocationsResponse> {
    ...
    return promise.then((data) => QueryAllocationsResponse.decode(new BinaryReader(data)));
  }

  QueryPayouts(request: QueryPayoutsRequest): Promise<QueryPayoutsResponse> {
    const data = QueryPayoutsRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "QueryPayouts", data);
    return promise.then((data) => QueryPayoutsResponse.decode(new BinaryReader(data)));
  }
  ...
  QueryPayoutsForAccount(request: QueryPayoutsForAccountRequest): Promise<QueryPayoutsForAccountResponse> {
    ...
    return promise.then((data) => QueryPayoutsForAccountResponse.decode(new BinaryReader(data)));
  }
  ...
  QueryPayoutsForNode(request: QueryPayoutsForNodeRequest): Promise<QueryPayoutsForNodeResponse> {
    ...
    return promise.then((data) => QueryPayoutsForNodeResponse.decode(new BinaryReader(data)));
  }

  QueryPayout(request: QueryPayoutRequest): Promise<QueryPayoutResponse> {
    const data = QueryPayoutRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "QueryPayout", data);
    return promise.then((data) => QueryPayoutResponse.decode(new BinaryReader(data)));
  }
  ...
  QuerySubscriptionsForNode(request: QuerySubscriptionsForNodeRequest): Promise<QuerySubscriptionsForNodeResponse> {
    ...
    return promise.then((data) => QuerySubscriptionsForNodeResponse.decode(new BinaryReader(data)));
  }
