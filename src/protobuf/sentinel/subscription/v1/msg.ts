...
export const MsgAddQuotaRequest: MessageFns<MsgAddQuotaRequest> = {
  encode(message: MsgAddQuotaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgAddQuotaRequest {
...
export const MsgSubscribeToNodeRequest: MessageFns<MsgSubscribeToNodeRequest> = {
  encode(message: MsgSubscribeToNodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
    if (message.address !== "") {
    ...
    if (message.deposit !== undefined) {
      Coin.encode(message.deposit, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubscribeToNodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSubscribeToPlanRequest: MessageFns<MsgSubscribeToPlanRequest> = {
  encode(message: MsgSubscribeToPlanRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
    if (!message.id.equals(Long.UZERO)) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubscribeToPlanRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateQuotaRequest: MessageFns<MsgUpdateQuotaRequest> = {
  encode(message: MsgUpdateQuotaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
    if (!message.id.equals(Long.UZERO)) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateQuotaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgAddQuotaResponse: MessageFns<MsgAddQuotaResponse> = {
  encode(_: MsgAddQuotaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgAddQuotaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSubscribeToNodeResponse: MessageFns<MsgSubscribeToNodeResponse> = {
  encode(_: MsgSubscribeToNodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubscribeToNodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgSubscribeToPlanResponse: MessageFns<MsgSubscribeToPlanResponse> = {
  encode(_: MsgSubscribeToPlanResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgSubscribeToPlanResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateQuotaResponse: MessageFns<MsgUpdateQuotaResponse> = {
  encode(_: MsgUpdateQuotaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateQuotaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgServiceClientImpl implements MsgService {
  ...
  MsgAddQuota(request: MsgAddQuotaRequest): Promise<MsgAddQuotaResponse> {
    ...
    return promise.then((data) => MsgAddQuotaResponse.decode(new BinaryReader(data)));
  }
  ...
  MsgSubscribeToNode(request: MsgSubscribeToNodeRequest): Promise<MsgSubscribeToNodeResponse> {
    ...
    return promise.then((data) => MsgSubscribeToNodeResponse.decode(new BinaryReader(data)));
  }
  ...
  MsgSubscribeToPlan(request: MsgSubscribeToPlanRequest): Promise<MsgSubscribeToPlanResponse> {
    ...
    return promise.then((data) => MsgSubscribeToPlanResponse.decode(new BinaryReader(data)));
  }

  MsgUpdateQuota(request: MsgUpdateQuotaRequest): Promise<MsgUpdateQuotaResponse> {
    const data = MsgUpdateQuotaRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "MsgUpdateQuota", data);
    return promise.then((data) => MsgUpdateQuotaResponse.decode(new BinaryReader(data)));
  }
}
