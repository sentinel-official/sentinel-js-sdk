...
export const QueryQuotasRequest: MessageFns<QueryQuotasRequest> = {
  encode(message: QueryQuotasRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryQuotasRequest {
...
export const QueryQuotaRequest: MessageFns<QueryQuotaRequest> = {
  encode(message: QueryQuotaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.id.equals(Long.UZERO)) {
      writer.uint32(8).uint64(message.id.toString());
    }
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryQuotaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySubscriptionsForAddressRequest: MessageFns<QuerySubscriptionsForAddressRequest> = {
  encode(message: QuerySubscriptionsForAddressRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySubscriptionsForAddressRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryQuotasResponse: MessageFns<QueryQuotasResponse> = {
  encode(message: QueryQuotasResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryQuotasResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryQuotaResponse: MessageFns<QueryQuotaResponse> = {
  encode(message: QueryQuotaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.quota !== undefined) {
      Quota.encode(message.quota, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryQuotaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuerySubscriptionsForAddressResponse: MessageFns<QuerySubscriptionsForAddressResponse> = {
  encode(message: QuerySubscriptionsForAddressResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.subscriptions) {
      Subscription.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuerySubscriptionsForAddressResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export class QueryServiceClientImpl implements QueryService {
  ...
  QueryQuotas(request: QueryQuotasRequest): Promise<QueryQuotasResponse> {
    ...
    return promise.then((data) => QueryQuotasResponse.decode(new BinaryReader(data)));
  }

  QueryQuota(request: QueryQuotaRequest): Promise<QueryQuotaResponse> {
    const data = QueryQuotaRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "QueryQuota", data);
    return promise.then((data) => QueryQuotaResponse.decode(new BinaryReader(data)));
  }
  ...
  QuerySubscriptionsForAddress(
    ...
    return promise.then((data) => QuerySubscriptionsForAddressResponse.decode(new BinaryReader(data)));
  }
