...
export const MsgRegisterProviderRequest: MessageFns<MsgRegisterProviderRequest> = {
  encode(message: MsgRegisterProviderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgRegisterProviderRequest {
...
export const MsgUpdateProviderDetailsRequest: MessageFns<MsgUpdateProviderDetailsRequest> = {
  encode(message: MsgUpdateProviderDetailsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateProviderDetailsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateProviderStatusRequest: MessageFns<MsgUpdateProviderStatusRequest> = {
  encode(message: MsgUpdateProviderStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.from !== "") {
      writer.uint32(10).string(message.from);
    }
    if (message.status !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateProviderStatusRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgRegisterProviderResponse: MessageFns<MsgRegisterProviderResponse> = {
  encode(_: MsgRegisterProviderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgUpdateProviderDetailsResponse: MessageFns<MsgUpdateProviderDetailsResponse> = {
  encode(_: MsgUpdateProviderDetailsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateProviderDetailsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateProviderStatusResponse: MessageFns<MsgUpdateProviderStatusResponse> = {
  encode(_: MsgUpdateProviderStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgUpdateProviderStatusResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgServiceClientImpl implements MsgService {
  ...
  MsgUpdateProviderDetails(request: MsgUpdateProviderDetailsRequest): Promise<MsgUpdateProviderDetailsResponse> {
    ...
    return promise.then((data) => MsgUpdateProviderDetailsResponse.decode(new BinaryReader(data)));
  }
  ...
  MsgUpdateProviderStatus(request: MsgUpdateProviderStatusRequest): Promise<MsgUpdateProviderStatusResponse> {
    ...
    return promise.then((data) => MsgUpdateProviderStatusResponse.decode(new BinaryReader(data)));
  }
